...
-   But one IQ point is no big deal, so the value $\mu = 101$ certainly does not represent a departure from $H_{0}$ that has practical significance.
-   The table on the next slide shows the relationship between the sample size and p-value and $\beta$.
